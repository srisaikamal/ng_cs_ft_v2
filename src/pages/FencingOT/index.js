...
import { withStyles, Tabs, Tab, Chip } from '@material-ui/core';
import {
  Home,
  ExitToApp,
  AddBox,
  ...
  getHeader() {
    ...
    return (
      <div>
        ...
        >
          <Tab
            label={<b style={{ color: 'white' }}>{casesTabTitle}</b>}
            value='Cases'
          />
        ...
        return (
          <Cases
            ...
            onRowSelect={(event, selectedRow) =>
              this.setState({ selectedCase: selectedRow })
            }
          />
        );
      default:
        return <Reports selectedCase={this.state.selectedCase} />;
    }
  }
}
